...
Debug.JustUpdateDeviceLine();
b4xdialog.__c.runVoidMethod ("LogImpl","97208996",RemoteObject.concat(RemoteObject.createImmutable("Time: "),(RemoteObject.solve(new RemoteObject[] {b4xdialog.__c.getField(false,"DateTime").runMethod(true,"getNow"),_n}, "-",1, 2))),0);
