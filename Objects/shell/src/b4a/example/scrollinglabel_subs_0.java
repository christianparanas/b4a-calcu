...
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",25,__ref.getField(false, "ba"),__ref,97);
